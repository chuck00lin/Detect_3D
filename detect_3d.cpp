...
//change_log1
    ...
    video_writer.open("video/video_src.avi",CAP_OPENCV_MJPEG , 30, cv::Size(640, 480));
    video_writer2.open("video/video_RGB.avi", CAP_OPENCV_MJPEG, 30, cv::Size(640, 480));
    video_writer4.open("video/video_depth.avi", CAP_OPENCV_MJPEG, 30, cv::Size(640, 480));
    video_writer44.open("video/video_depth_src.avi", CAP_OPENCV_MJPEG, 30, cv::Size(640, 480));
    video_writer5.open("video/video_distance.avi", CAP_OPENCV_MJPEG, 30, cv::Size(900, 640));
...
void detect_3d::on_point_cloud_clicked()
{
    ...
    write_depth.open("video/video_depth_pc.avi", CAP_OPENCV_MJPEG, 30, cv::Size(1280, 720));
...
void detect_3d::on_camera_pose_clicked()
{
    ...
    video_writer.open("pose_result/raw_video.avi", CAP_OPENCV_MJPEG, 30, cv::Size(640, 480));
